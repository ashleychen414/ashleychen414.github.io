...
!(function(t) {
  t.fn.openWeather = function(e) {
    ...
    let a,
      ...
      s,
      u,
      o = "//api.openweathermap.org/data/2.5/weather?lang=" + r.lang;
    null != r.city
      ? (o += "&q=" + r.city)
      : null != r.lat &&
        null != r.lng &&
        (o += "&lat=" + r.lat + "&lon=" + r.lng),
      ...
      t.ajax({
        ...
        success: function(e) {
          if (e) {
            if (
              ("f" == r.units
                ? ((l = Math.round(1.8 * (e.main.temp - 273.15) + 32) + "°F"),
                  (s =
                    Math.round(1.8 * (e.main.temp_min - 273.15) + 32) + "°F"),
                  (u =
                    Math.round(1.8 * (e.main.temp_max - 273.15) + 32) + "°F"))
                : ((l = Math.round(e.main.temp - 273.15) + "°C"),
              ...
              n.html(l),
              null != r.minTemperatureTarget &&
                t(r.minTemperatureTarget).text(s),
              null != r.maxTemperatureTarget &&
                t(r.maxTemperatureTarget).text(u),
            ...
            null != r.placeTarget && t(r.placeTarget).text(a.city),
              null != r.windSpeedTarget &&
                t(r.windSpeedTarget).text(a.windspeed),
