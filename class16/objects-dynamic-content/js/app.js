$("document").ready(function() {
  ...
  $(".elem-1__title").append(pageLoadData.elem1.title);
  $(".elem-1__date").append(pageLoadData.elem1.date);
  ...
  $(".elem-2__title").append(pageLoadData.elem2.title);
  $(".elem-2__date").append(pageLoadData.elem2.date);
  ...
  $(".elem-3__title").append(pageLoadData.elem3.title);
  $(".elem-3__date").append(pageLoadData.elem3.date);
  ...
  $(".elem-4__title").append(pageLoadData.elem4.title);
  $(".elem-4__date").append(pageLoadData.elem4.date);
  // Put the created at date from our data object into the footer's h1
  $(".footer__h1").append(pageLoadData.createdAt);
});
